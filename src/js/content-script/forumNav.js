import {
    AUTO_OPEN_PARAM,
    FORUM_CURRENT_PAGE_CLASSES,
    FORUM_NAV_ELEMENTS,
    FORUM_NAV_LINK_ELEMENTS,
    PREFIX,
} from './variables';

/**
 * Build forum navigation
 * @param {DOMElement} container Galleryzer container element
 * @param {DOMElement} forumNav  Forum nav to search
 */
 ...
 * @return {Boolean}
 */
export function isCurrentPage(el) {
    ...
    return FORUM_CURRENT_PAGE_CLASSES.some((currentPageClass) =>
        classNames.includes(currentPageClass)
    );
}
